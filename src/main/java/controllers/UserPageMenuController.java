...
public class UserPageMenuController extends UserPageControllerAbstract {
    ...
    public void initializeWithData(User user, boolean islightMode) {
        ...
        restaurantInfoButton.setDisable(true);
        dishesButton.setDisable(true);
    ...
    private void createPdf(List<String> orderDetails, int paperSize, int id) {
        ...
        try (PDDocument document = new PDDocument()) {
            ...
            try (PDPageContentStream contentStream = new PDPageContentStream(document, page)) {
                PDType0Font font = PDType0Font.load(document, UserPageMenuController.class.getResourceAsStream("/styles/fonts/DejaVuSans.ttf"));
